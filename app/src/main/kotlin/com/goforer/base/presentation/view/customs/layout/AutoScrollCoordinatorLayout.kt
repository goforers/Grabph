 ...
 */
class AutoScrollCoordinatorLayout @JvmOverloads constructor(context: Context, attrs: AttributeSet ? = null): CoordinatorLayout(context, attrs) {
    ...
    companion object {
        ...
        private const val SWIPE_THRESHOLD_VELOCITY_Y = 10f
    }
