...
class BottomButtonBehavior(context: Context, attrs: AttributeSet): CoordinatorLayout.Behavior<AppCompatButton>(context, attrs) {
    ...
    override fun layoutDependsOn(parent: CoordinatorLayout, child: AppCompatButton, dependency: View): Boolean {
    ...
    override fun onStartNestedScroll(coordinatorLayout: CoordinatorLayout, child: AppCompatButton,
    ...
    override fun onNestedPreScroll(coordinatorLayout: CoordinatorLayout, child: AppCompatButton,
    ...
    override fun onStopNestedScroll(coordinatorLayout: CoordinatorLayout, child: AppCompatButton,
