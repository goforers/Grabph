...
class BottomConstraintBehavior(context: Context, attrs: AttributeSet): CoordinatorLayout.Behavior<ConstraintLayout>(context, attrs) {
    @NestedScrollType
    ...
    override fun onStartNestedScroll(coordinatorLayout: CoordinatorLayout, child: ConstraintLayout,
    ...
    override fun onNestedPreScroll(coordinatorLayout: CoordinatorLayout, child: ConstraintLayout,
    ...
    override fun onStopNestedScroll(coordinatorLayout: CoordinatorLayout, child: ConstraintLayout,
