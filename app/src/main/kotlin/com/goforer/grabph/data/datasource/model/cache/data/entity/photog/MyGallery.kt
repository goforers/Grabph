...
data class MyGallery(
    ...
    @field:ColumnInfo(name = "isfamily") var isfamily: Int,
    @field:ColumnInfo(name = "media") var media: String,
    @field:ColumnInfo(name = "urlm") var url_m: String?,
    @field:ColumnInfo(name = "urlz") var url_z: String?
) : BaseModel() {
    companion object {
