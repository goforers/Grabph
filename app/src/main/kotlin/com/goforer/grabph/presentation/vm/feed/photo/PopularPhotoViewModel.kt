...
@Inject
constructor(val interactor: PopularPhotoRepository) : BaseViewModel() {
    @VisibleForTesting
    ...
    init {
        photogPhotos = Transformations.switchMap(liveData) { query ->
            ...
            liveData(context = viewModelScope.coroutineContext + Dispatchers.IO) {
                emitSource(interactor.load(this@PopularPhotoViewModel, query?.userID!!, query.pages, loadType, boundType, calledFrom))
            }
        }
    }
