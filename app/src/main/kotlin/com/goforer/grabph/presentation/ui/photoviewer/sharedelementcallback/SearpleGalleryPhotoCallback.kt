...
package com.goforer.grabph.presentation.ui.photoviewer.sharedelementcallback
...
class SearpleGalleryPhotoCallback: SharedElementCallback() {
    ...
    override fun onMapSharedElements(names: MutableList<String>?, sharedElements: MutableMap<String, View>?) {
        ...
        mapSharedElement(names, sharedElements, view)
    }
