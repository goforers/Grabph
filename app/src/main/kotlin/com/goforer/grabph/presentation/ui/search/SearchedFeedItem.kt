...
object SearchedFeedItem {
    ...
    fun getSearchedFeedItems(): List<FeedItem> {
        return feedItems
    }

    fun setSearchedFeedItems(feedItems: List<FeedItem>) {
        SearchedFeedItem.feedItems.clear()
        SearchedFeedItem.feedItems.addAll(feedItems)
    }
}