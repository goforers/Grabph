...
package com.goforer.grabph.presentation.ui.categoryphoto.sharedElementCallback
...
class CategoryPhotoListCallback(private val intent: Intent): SharedElementCallback() {
    ...
    fun setViewBinding(imageView: AppCompatImageView) {
