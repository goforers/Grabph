...
import com.goforer.grabph.data.repository.remote.feed.photo.PopularPhotoRepository
...
@Singleton
class LoadPopularPhotoUseCase
@Inject
constructor(private val repository: PopularPhotoRepository):  BaseUseCase<Parameters, Resource>() {
