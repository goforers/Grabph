...
import com.goforer.grabph.data.repository.remote.feed.photo.PhotoRepository
...
@Inject
constructor(private val repository: PhotoRepository):  BaseUseCase<Parameters, Resource>() {
