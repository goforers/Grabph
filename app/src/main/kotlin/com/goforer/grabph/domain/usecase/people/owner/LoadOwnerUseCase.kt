...
package com.goforer.grabph.domain.usecase.people.owner
...
import com.goforer.grabph.data.repository.remote.people.owner.OwnerRepository
...
@Singleton
class LoadOwnerUseCase
@Inject
constructor(private val repository: OwnerRepository):  BaseUseCase<Parameters, Resource>() {
    ...
    internal fun loadOwner() = repository.loadOwner()

    @MockData
    internal suspend fun setOwner(owner: Owner) = repository.setOwner(owner)

    internal suspend fun deleteOwner() = repository.removeOwner()
}