...
import com.goforer.grabph.repository.interactor.remote.feed.FeedContentRepository
...
@Singleton
class LoadFeedContentUseCase
@Inject
constructor(private val repository: FeedContentRepository): BaseUseCase<Parameters, Resource>() {
    ...
    @MockData
    internal fun getFeedContent() =  repository.loadFeedsContent()

    @MockData
    internal suspend fun setFeedsContent(feedsContent: FeedsContent) = repository.setFeedsContent(feedsContent)
}