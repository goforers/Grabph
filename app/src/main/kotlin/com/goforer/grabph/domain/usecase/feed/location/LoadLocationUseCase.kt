...
import com.goforer.grabph.data.repository.remote.feed.location.LocationRepository
...
@Inject
constructor(private val repository: LocationRepository):  BaseUseCase<Parameters, Resource>() {
    ...
    internal suspend fun removeLocation() = repository.removeLocation()
}