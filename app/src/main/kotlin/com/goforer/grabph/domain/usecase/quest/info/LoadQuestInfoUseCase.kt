...
package com.goforer.grabph.domain.usecase.quest.info
...
@Singleton
class LoadQuestInfoUseCase
@Inject
constructor(private val repository: QuestInfoRepository): BaseUseCase<Parameters, Resource>() {
    ...
    @MockData
    internal fun loadQuestInfo() = repository.loadQuestInfo()

    @MockData
    internal suspend fun setQuestInfo(questInfo: QuestInfo) {
        repository.setQuestInfo(questInfo)
    }

    internal suspend fun deleteQuestInfo() = repository.deleteQuestInfo()
}