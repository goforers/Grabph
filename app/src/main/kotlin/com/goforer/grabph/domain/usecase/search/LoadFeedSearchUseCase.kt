...
import com.goforer.grabph.data.repository.remote.search.FeedSearchRepository
...
@Singleton
class LoadFeedSearchUseCase
@Inject
constructor(private val repository: FeedSearchRepository): BaseUseCase<Parameters, Resource>() {
    ...
    internal fun loadPinnedupFeed() = repository.loadPinnedupFeed()
