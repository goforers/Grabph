...
package com.goforer.grabph.domain.usecase.hottopic
...
@Singleton
class LoadHotTopicUseCase
@Inject
constructor(private val repository: HotTopicContentRepository):  BaseUseCase<Parameters, Resource>() {
    ...
    @MockData
    internal suspend fun loadHotTopicContent() = repository.loadHotTopicContent()

    @MockData
    internal suspend fun setHotTopicContent(hotTopicContent: HotTopicContent) = repository.setHotTopicContent(hotTopicContent)
}