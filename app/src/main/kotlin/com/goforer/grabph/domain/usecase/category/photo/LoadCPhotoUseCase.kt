...
package com.goforer.grabph.domain.usecase.category.photo
...
import com.goforer.grabph.data.repository.remote.category.photo.CPhotoRepository
...
@Singleton
class LoadCPhotoUseCase
@Inject
constructor(private val repository: CPhotoRepository):  BaseUseCase<Parameters, Resource>() {
    ...
    internal suspend fun updatePhoto(photo: CPhoto) = repository.update(photo)
